...
// Start Coding Here
const sendNotification = (callback, action) => {
    return callback(action);
}

let deletemessage = "แจ้งเตือน: ลบโพสต์สำเร็จ";
...
console.log(sendNotification(postDeleted, deletemessage));
